...
describe("findEvents", () => {
                    ...
                    .then(user =>
                        User.create({ name: "Casal Cultural", username: "casalcultural", email: "casal@cultural.com", password: "123qwe123", city: "Manresa", address: "Carretera de Vic", status: "active", role: "organization" })
                            .then((org) => Promise.all([
                                org,
                                Event.create({ title: "Taller de pintura infantil", author: org._id, city: org.city, address: org.address, date: "2024-05-24", time: "17:00:00", description: "Taller per a nens de pintura en aquarel·la.", price: 2, categories: ["Tallers", "Infantil", "Art"] }),
                                Event.create({ title: "Concert escola de música municipal", author: org._id, city: org.city, address: org.address, date: "2024-06-11", time: "18:30:00", description: "Concert dels alumnes de l'escola de música municipal. Seguit amb un berenar per a tots. - Sala polivalent", price: 0, categories: ["Concerts", "Infantil"] }),
                                Event.create({ title: "Club de lectura: Mirall trencat", author: org._id, city: org.city, address: org.address, date: "2024-05-23", time: "18:30:00", description: "Club de lectura per comentar Mirall trencat de Mercè Rodoreda", price: 0, categories: ["Llibres"] })

                            ])
                                .then(([org, event1, event2, event3]) => logic.findEvents({})
                                    .then(results => {
                            ...
                            .then(org => Event.create({ title: "Taller de pintura infantil", author: org._id, city: org.city, address: org.address, date: "2024-05-23", time: "17:00:00", description: "Taller per a nens de pintura en aquarel·la.", price: 2 })
                                .then(event1 => Event.create({ title: "Concert escola de música municipal", author: org._id, city: org.city, address: org.address, date: "2024-06-11", time: "18:30:00", description: "Concert dels alumnes de l'escola de música municipal. Seguit amb un berenar per a tots. - Sala polivalent", price: 0 })
                                    .then(event2 => Event.create({ title: "Club de lectura: Mirall trencat", author: org._id, city: org.city, address: org.address, date: "2024-05-23", time: "18:30:00", description: "Club de lectura per comentar Mirall trencat de Mercè Rodoreda", price: 0 })
                                        ...
                                        .then(event3 =>
                                            logic.findEvents({ date: "2024-05-23" })
                                                .then(results => {
                            ...
                            .then(org => Event.create({ title: "Taller de pintura infantil", author: org._id, city: org.city, address: org.address, date: "2024-05-23", time: "17:00:00", description: "Taller per a nens de pintura en aquarel·la.", price: 2, categories: ["Tallers", "Infantil", "Art"] })
                                .then(event1 => Event.create({ title: "Concert escola de música municipal", author: org._id, city: org.city, address: org.address, date: "2024-06-11", time: "18:30:00", description: "Concert dels alumnes de l'escola de música municipal. Seguit amb un berenar per a tots. - Sala polivalent", price: 0, categories: ["Concerts", "Infantil"] })
                                    .then(event2 => Event.create({ title: "Club de lectura: Mirall trencat", author: org._id, city: org.city, address: org.address, date: "2024-05-23", time: "18:30:00", description: "Club de lectura per comentar Mirall trencat de Mercè Rodoreda", price: 0, categories: ["Llibres"] })
                                        .then(event3 =>
                                            logic.findEvents({ organizationId: org.id, categories: ["Infantil"] })
                                                .then(results => {
                                                    expect(results).to.have.lengthOf(2)
    ...
    it("Should retrieve all events by specific organization", () =>
        Promise.all([
            User.deleteMany(),
            Event.deleteMany()
        ])
            .then(() => Promise.all([
                User.create({ name: "Pepe Roni", username: "peperoni", email: "pepe@roni.com", password: "123qwe123", status: "active", role: "regular" }),
                User.create({ name: "Casal Cultural", username: "casalcultural", email: "casal@cultural.com", password: "123qwe123", city: "Manresa", address: "Carretera de Vic", status: "active", role: "organization" }),
                User.create({ name: "Casal 2", username: "casal2", email: "casal2@gmail.com", password: "123qwe123", city: "Manresa", address: "Carretera de Vic", status: "active", role: "organization" })
            ])
                .then(([user, org1, org2]) => Promise.all([
                    Event.create({ title: "Taller de pintura infantil", author: org1._id, city: org1.city, address: org1.address, date: "2024-05-23", time: "17:00:00", description: "Taller per a nens de pintura en aquarel·la.", price: 2, categories: ["Tallers", "Infantil", "Art"] }),
                    Event.create({ title: "Concert escola de música municipal", author: org1._id, city: org1.city, address: org1.address, date: "2024-06-11", time: "18:30:00", description: "Concert dels alumnes de l'escola de música municipal. Seguit amb un berenar per a tots. - Sala polivalent", price: 0, categories: ["Concerts", "Infantil"] }),
                    Event.create({ title: "Club de lectura: Mirall trencat", author: org2._id, city: org2.city, address: org2.address, date: "2024-05-24", time: "18:30:00", description: "Club de lectura per comentar Mirall trencat de Mercè Rodoreda", price: 0, categories: ["Llibres"] })
                ])
                    .then(([event1, event2, event3]) => logic.findEvents({ organizationId: org1.id })
                        .then(results => {
                            expect(results).to.have.lengthOf(2)
