...
function createEvent(organizationId: string, title: string, date: string, time: string, description: string, price: number, city?: string, address?: string,): Promise<void> {
    debugger
