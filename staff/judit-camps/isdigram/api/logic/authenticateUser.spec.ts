...
describe('authenticateUser', () => {
    ...
    it('succeeds on login for existing user & correct credentials', () =>
        User.deleteMany()
    ...
    it('fails on existing user and incorrect password', () =>
        User.deleteMany()
            .then(() => User.create({ name: 'Pepe Roni', birthdate: '2000-01-01', email: 'pepe@roni.com', username: 'peperoni', password: '123qwe123' }))
            .then(() => logic.authenticateUser('peperoni', '234wer234'))
            .catch((error) => {
    ...
    it('fails on existing user and incorrect username', () =>
        User.deleteMany()
            .then(() => User.create({ name: 'Pepe Roni', birthdate: '2000-01-01', email: 'pepe@roni.com', username: 'peperoni', password: '123qwe123' }))
            .then(() => logic.authenticateUser('paparoni', '123qwe123'))
            .catch(error => {
